...
export function JobCard({ job, onClick, isExpanded = false, isSelected, onToggleSelect }: JobCardProps) {
          ...
          <div className="flex gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-foreground mb-1">
                {job.job_number}
                {job.nickname && <span className="text-sm text-muted-foreground ml-2">({job.nickname})</span>}
              </div>
